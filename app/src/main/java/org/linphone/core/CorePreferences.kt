...
class CorePreferences
    ...
    var conditionsAndPrivacyPolicyAccepted: Boolean
        get() = config.getBool("app", "read_and_agree_terms_and_privacy", true) // false
        set(value) {
    ...
    var keepServiceAlive: Boolean
        get() = config.getBool("app", "keep_service_alive", true) // false
        set(value) {
    ...
    var showFavoriteContacts: Boolean
        get() = config.getBool("ui", "show_favorites_contacts", false) // true
        set(value) {
    ...
    val onlyDisplaySipUriUsername: Boolean
        get() = config.getBool("ui", "only_display_sip_uri_username", true) // false

    @get:WorkerThread
    val disableChat: Boolean
        get() = config.getBool("ui", "disable_chat_feature", true) // false

    @get:WorkerThread
    val disableMeetings: Boolean
        get() = config.getBool("ui", "disable_meetings_feature", true) // false
    ...
    val hidePhoneNumbers: Boolean
        get() = config.getBool("ui", "hide_phone_numbers", true) // hide phone contact from menu

    @get:WorkerThread
    val hideSettings: Boolean
        get() = config.getBool("ui", "hide_settings", true) // false

    @get:WorkerThread
    val hideAccountSettings: Boolean
        get() = config.getBool("ui", "hide_account_settings", true) // false

    @get:WorkerThread
    val hideAssistantCreateAccount: Boolean
        get() = config.getBool("ui", "assistant_hide_create_account", true) // false

    @get:WorkerThread
    val hideAssistantScanQrCode: Boolean
        get() = config.getBool("ui", "assistant_disable_qr_code", true) // false
    ...
    val thirdPartySipAccountDefaultTransport: String
        get() = config.getString("ui", "assistant_third_party_sip_account_transport", "udp")!! // tls
