...
val packageName = "com.tensol.livephone" // "org.linphone"
...
android {
    ...
    applicationVariants.all {
        ...
        variant.outputs
            ...
            .forEach { output ->
                output.outputFileName = "livephone-android-${variant.buildType.name}-${project.version}.apk"
            }
    }
    ...
    signingConfigs {
        create("release") {
            ...
            storeFile = file("D:\\Android\\2024.2.2\\Projects\\Tensol\\homebell\\Live_Phone\\tensol.keystore")
            storePassword = "ranjan@99"
            keyAlias = "Tensol"
            keyPassword = "ranjan@99"
            if (keyStore.exists()) {
                storeFile = keyStore
